...
// CONDITION:- do same but using without push(make polyfill)
...
// Array.prototype.pushElement = function(...args){ // rest parameters. will wrap values in an actual array, ES6.
...
//   return length
// }
// // NOTE:- we can do the same with using arguments. arguments is an array-like object containing all passed values. arguments is used in older versions and not supported in arrow function, also can't use array methods

// array.pushElement(newValue)
// console.log(array)
